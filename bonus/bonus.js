...
/*fucntion lexicographicalOrder(word1, word2){
...
function shortestWord(word1, word2, word3) {
  if (word1.length > word3.length && word2.length > word3.length){
    return word3 
  } else if (word2.length > word1.length && word3.length > word1.length){
    return word1
  } else {
    return word2
  }
